...
import ArmMPC.tools.Fel_ExpressionProc;
import ArmRacos.Componet.Instance;
import ArmRacos.ObjectiveFunction.ObjectFunction;
...
//            ValueArc valueArc = con.run2();
    ...
    void checkAutomata() {
        println("*******Basic information of Automata "+ labelasName+"*******");
